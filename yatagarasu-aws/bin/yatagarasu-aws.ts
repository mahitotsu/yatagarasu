...
const rdbPrimaryClusterStack = new RdbPrimaryClusterStack(app, 'RdbPrimaryClusterStack', {
  env: hndConfig.env,
  crossRegionReferences: true,
  vpc: hndVpcStack.vpc,
...
const rdbSecondaryClusterStack = new RdbSecondaryClusterStack(app, 'RdbSecondaryClusterStack', {
  env: kixConfig.env,
  crossRegionReferences: true,
  vpc: kixVpcStack.vpc,
  vpcSubnets: { subnetType: SubnetType.PRIVATE_ISOLATED },
  rdbClusterEngine: rdbClusterEngine,
  globalClusterIdentifier: rdbPrimaryClusterStack.globalClusterIndentifier,
});